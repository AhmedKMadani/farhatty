...
public class OrderPhotoActivity extends AppCompatActivity {
    ...
    private void showService() {
        ...
        for (int i =0 ; i < ViewPhotographerActivity.orderp.size () ; i++) {

            OrdersList odr =  new OrdersList (  );

            odr.setTitle ( ViewPhotographerActivity.orderp.get ( i ).getTitle () );
            odr.setPrice ( ViewPhotographerActivity.orderp.get ( i ).getService_Price () );

            price = Double.parseDouble ( ViewPhotographerActivity.orderp.get ( i ).getService_Price () );
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        String URL = "http://farhatty.sd/WebService.asmx";
            ...
            Request.addProperty ( "Ndays", photo_id );
...
**/
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderPhotoActivity.this );
