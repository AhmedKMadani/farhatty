...
public class OrderChefActivity extends AppCompatActivity {
    ...
    private void showService() {
        ...
        for (int i =0 ; i < ViewChefActivity.orderch.size () ; i++) {

            OrdersList odr =  new OrdersList (  );

            odr.setTitle ( ViewChefActivity.orderch.get ( i ).getTitle () );
            odr.setPrice ( ViewChefActivity.orderch.get ( i ).getService_Price () );

            price = Double.parseDouble ( ViewChefActivity.orderch.get ( i ).getService_Price () );
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        String URL = "http://farhatty.sd/WebService.asmx";
            ...
            Request.addProperty ( "Ndays", chef_id );
...
**/
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderChefActivity.this );
