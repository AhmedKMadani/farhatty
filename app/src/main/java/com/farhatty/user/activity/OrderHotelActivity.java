...
public class OrderHotelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view_hotel_id =  getIntent().getStringExtra("hotel_id") ;
        view_hotel_price =  getIntent ().getStringExtra ( "price" );
        pricesum = Integer.parseInt ( getIntent ().getStringExtra ( "number_of_d" ) );
    ...
    private void setTotalPrice() {
        ...
        Double _total_order = Double.valueOf(view_hotel_price), _price_tax = 0D;
        String _total_order_str, _price_tax_str;

        _total_fees = _total_order * (double)pricesum;
        ...
        tax.setText(getString(R.string.number_days)  + ":" );
        price_tax.setText( pricesum + " " + getResources ().getString ( R.string.days ) );
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        String URL = "http://farhatty.sd/WebService.asmx";
            ...
            Request.addProperty ( "Ndays", pricesum );
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderHotelActivity.this );
