...
public class OrderCoiffureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view_coiffure_id =  getIntent().getStringExtra("coiffure_id_s") ;
        coiffure_id = Integer.parseInt(view_coiffure_id);
    ...
    private void showService() {
        ...
        for (int i =0 ; i < ViewCoiffureActivity.orderc.size () ; i++) {

            OrdersList odr =  new OrdersList (  );

            odr.setTitle ( ViewCoiffureActivity.orderc.get ( i ).getTitle () );
            odr.setPrice ( ViewCoiffureActivity.orderc.get ( i ).getService_Price () );

            price = Double.parseDouble ( ViewCoiffureActivity.orderc.get ( i ).getService_Price () );
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.YES, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        OrderCoiffureActivity.this.finish();
                    }
                })
    ...
    private void setTotalPrice() {
        ...
        Double _total_order = Double.valueOf(pricesum), _price_tax = 0D;
        String _total_order_str, _price_tax_str;

        _total_fees = _total_order ;
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        String URL = "http://farhatty.sd/WebService.asmx";
            ...
            Request.addProperty ( "Ndays", coiffure_id );
    ...
    private void submitForm() {
        ...
        if (!validateResvertion ()) {
            ...
            Snackbar.make(parent_view, R.string.invalid_date, Snackbar.LENGTH_SHORT).show();
             **/
        }else {
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderCoiffureActivity.this );
