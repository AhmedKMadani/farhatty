...
public class OrderArtistActivity extends AppCompatActivity {
    ...
    private void showService() {
        ...
        for (int i =0 ; i < ViewArtistActivity.ordera.size () ; i++) {

            OrdersList odr =  new OrdersList (  );

            odr.setTitle ( ViewArtistActivity.ordera.get ( i ).getTitle () );
            odr.setPrice ( ViewArtistActivity.ordera.get ( i ).getService_Price () );

            price = Double.parseDouble ( ViewArtistActivity.ordera.get ( i ).getService_Price () );
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.YES, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        OrderArtistActivity.this.finish();
                    }
                })
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        protected SoapObject doInBackground(Void... params) {
            ...
            Request.addProperty ( "Ndays", artist_id );
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderArtistActivity.this );
