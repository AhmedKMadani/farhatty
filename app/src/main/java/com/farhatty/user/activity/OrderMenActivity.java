...
public class OrderMenActivity extends AppCompatActivity {
    ...
    private void showService() {
        ...
        for (int i =0 ; i < ViewMenActivity.orderm.size () ; i++) {

            OrdersList odr =  new OrdersList (  );

            odr.setTitle ( ViewMenActivity.orderm.get ( i ).getTitle () );
            odr.setPrice ( ViewMenActivity.orderm.get ( i ).getService_Price () );

            price = Double.parseDouble (ViewMenActivity.orderm.get ( i ).getService_Price () );
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        protected SoapObject doInBackground(Void... params) {
            ...
            Request.addProperty ( "Ndays", men_id );
...
**/
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderMenActivity.this );
