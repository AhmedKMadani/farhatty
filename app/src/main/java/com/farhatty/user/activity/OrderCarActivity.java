...
public class OrderCarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_car_checkout );


        view_car_id = getIntent ().getStringExtra ( "car_id" );
        view_car_price = getIntent ().getStringExtra ( "price" );
    ...
    private void setTotalPrice() {
        ...
        Double _total_order = Double.valueOf ( view_car_price ), _price_tax = 0D;
    ...
    private class DoBooking extends AsyncTask <Void, Void, SoapObject> {
        ...
        protected SoapObject doInBackground(Void... params) {
            ...
            Request.addProperty ( "Ndays", car_id );
    ...
    private class CheckDate extends AsyncTask <Void, Void, Void> {
        @Override
        protected void onPreExecute() {
            progress = new ProgressDialog ( OrderCarActivity.this );
