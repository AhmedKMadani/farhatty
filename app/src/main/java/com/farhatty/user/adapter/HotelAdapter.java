...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.MyViewHolder>
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onHotelSelected(hotelListFiltered.get(getAdapterPosition()));
                }
            });
        }
    }
    ...
    public HotelAdapter(Context context, List<Hotel> hotelList, HotelAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.hotel_row_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final Hotel hotel = hotelListFiltered.get(position);
        holder.name.setText(hotel.getName());
        holder.location.setText(hotel.getLocation());
        Glide.with(context)
                .load(hotel.getImage()).apply (RequestOptions.circleCropTransform() )
                .into(holder.thumbnail);
    }

    @Override
    public int getItemCount() {
        return hotelListFiltered.size();
    }
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                hotelListFiltered = (ArrayList<Hotel>) filterResults.values;
